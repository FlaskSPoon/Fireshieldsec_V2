...
export default function AuditLayout({ children }) {
  return (
    <>
      <Head>
        <title>Conseil, Audit et Gouvernance du SI | Fireshield Security</title>
        <meta
          name="description"
          content="Cybersécurité, Gestion des systèmes d'information (SI), Conseil, Protection et Détection"
        />
      </Head>
      {children}
    </>
...
//     enabled: true,
//   });
// const getImageForService=(imageArray,index)=>{
//   return imageArray[index]?.bgImage||"/assets/img/icon/internet-security.png";
// }
...
//   const auditServices = allServices.filter(service => service.category?.id === 2);
//   const conseilServices = allServices.filter(service => service.category?.id === 3);
//   const gouvernanceServices = allServices.filter(service => service.category?.id === 4);
//   console.log('les services sont :', auditServices);
...
//                               : getImageForService(audit, index)
//                           }
//                           />
//                         ))}
...
//                               service.image
//                                 ? `${baseURL}/uploads/services/${service.image}`
//                                 : gouvernance[index]?.bgImage || '/assets/img/icon/serviceIcon1_8.png'
//                             }
//                           />
//                         ))}
//                       </div>
