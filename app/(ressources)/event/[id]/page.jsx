...
//                 <Link href="/event" className="btn btn-danger">
...
export default async function BlogDetailsPage(props) {
    ...
    try {
        ...
        const safeTags = Array.isArray(evenement.tags) ? evenement.tags : [];
            ...
            <>
                <div className="breadcrumb-wrapper">
                    ...
                    >
                        <div className="container">
                            <div className="page-heading">
                                <h1 className="animate-fade-in">{evenement.title}</h1>
                                <ul className="breadcrumb-items animate-fade-in">
                                    <li>
                                        <Link scroll={false} href={`/`}>
                                            Accueil
